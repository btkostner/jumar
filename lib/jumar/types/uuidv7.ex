defmodule Jumar.Types.UUIDv7 do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> cast(<<0x60, 0x1D, 0x74, 0xE4, 0xA8, 0xD3, 0x4B, 0x6E,
      ...>        0x83, 0x65, 0xED, 0xDB, 0x4C, 0x89, 0x33, 0x27>>)
      {:ok, "601d74e4-a8d3-4b6e-8365-eddb4c893327"}

      iex> cast("601d74e4-a8d3-4b6e-8365-eddb4c893327")
      {:ok, "601d74e4-a8d3-4b6e-8365-eddb4c893327"}

      iex> cast("warehouse worker")
  ...
  def load(<<_::64, ?-, _::32, ?-, _::32, ?-, _::32, ?-, _::96>> = string) do
    raise ArgumentError,
          "trying to load string UUID as Jumar.Types.UUIDv7: #{inspect(string)}. " <>
