defmodule Jumar.Accounts.UserToken do
  @moduledoc """
  Schema for user based tokens. These have multiple different "contexts"
  depending on what they are used for. This can be for password resets,
  user confirmation, or email changes.
  """
